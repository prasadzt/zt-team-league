	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Team Item', 'elementor-list-widget' ),
				'default' => esc_html__( 'Team Item', 'elementor-list-widget' ),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'team_items',
			[
				'label' => esc_html__( 'Team Items', 'elementor-list-widget' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),           /* Use our repeater */
				'default' => [
					[
						'text' => esc_html__( 'Team Item #1', 'elementor-list-widget' ),
						'link' => '',
					],
					[
						'text' => esc_html__( 'Team Item #2', 'elementor-list-widget' ),
						'link' => '',
					],
					[
						'text' => esc_html__( 'Team Item #3', 'elementor-list-widget' ),
						'link' => '',
					],
				],
				'title_field' => '{{{ text }}}',
        ...
        $this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Enter League', 'textdomain' ),
			]
		);
		...
		$this->start_controls_section(
			'marker_section',
			[
				'label' => esc_html__( 'Team Marker', 'elementor-list-widget' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'ordered' => [
						'title' => esc_html__( 'Ordered Team', 'elementor-list-widget' ),
						'icon' => 'eicon-editor-list-ol',
					],
					'unordered' => [
						'title' => esc_html__( 'Unordered Team', 'elementor-list-widget' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'other' => [
						'title' => esc_html__( 'Custom Team', 'elementor-list-widget' ),
						'icon' => 'eicon-edit',
					],
				],
				'default' => 'ordered',
